    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-6">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>A native wallet. Keys never leave this device.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <Button className="w-full" variant="outline" onClick={() => navigate("/onboarding/restore")}>
